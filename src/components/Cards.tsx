const PokemonCards = ({ pokemon, index }) => {
  ...
  return (
    <div className="bg-slate-900 border-4 flex flex-col mx-3 my-5 py-2 rounded-xl flex justify-center items-center">
      <h1 className="text-white  my-5 font-bold text-xl">{pokeIndex}</h1>
